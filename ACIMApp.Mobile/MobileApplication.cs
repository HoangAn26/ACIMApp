...
namespace ACIMApp.Mobile {
    ...
    public partial class ACIMAppMobileApplication : MobileApplication {
        ...
        private ACIMApp.Module.Mobile.ACIMAppMobileModule module4;
        ...
        static ACIMAppMobileApplication() {
        ...
        #endregion
        public ACIMAppMobileApplication() {
        ...
        private void ACIMAppMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
